...
makeGroups = "true"
URLP="http://KelTecPlay-iptv.directorioforuns.com/h113-baixe"
...
def Categories(msg): #70
	...
	#AddDir("[B]Sobre o Addon[/B]", "cPage" ,0 ,"http://icons.iconarchive.com/icons/kyo-tux/delikate/512/Info-icon.png", "http://icons.iconarchive.com/icons/kyo-tux/delikate/512/Info-icon.png", cPage, info="Addon modificado do PlaylistLoader 1.2.0 por Avigdor\r https://github.com/avigdork/xbmc-avigdork.\r\nNao somos responsáveis por colocar o conteúdo online, apenas indexamos.\r\nPara sugestões e report de bugs nossa pagina no FB: [COLOR blue]https://www.facebook.com/groups/KelTec.Media.Play/[/COLOR]\nVersão: "+Versao)
	#AddDir("[B][COLOR blue]https://www.facebook.com/groups/KelTec.Media.Play[/COLOR][/B]", "" ,0 ,"https://cdn.pixabay.com/photo/2017/08/20/10/30/facebook-2661207_960_720.jpg", "https://cdn.pixabay.com/photo/2017/08/20/10/30/facebook-2661207_960_720.jpg", isFolder=False, info="Para sugestões e report de bugs nossa pagina no FB: [COLOR blue]https://www.facebook.com/groups/KelTec.Media.Play[/COLOR]")
# --------------  Menu
def MCanais(): #-1
	link = common.OpenURL("https://pastebin.com/raw/")
	match = re.compile('(.+);(.+)').findall(link)
	for name2,url2 in match:
		AddDir("[COLOR while][B]["+name2+"][/COLOR][/B]" , url2, 102, "https://i62.servimg.com/u/f62/19/82/45/70/family10.png", "https://i62.servimg.com/u/f62/19/82/45/70/family10.png")
	setViewM()
def MFilmes(): #-2
	...
	#AddDir("[COLOR blue][B]Filmes Dublado RedeCanais[/B][/COLOR]" , cPage, 90, "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", background="cPage")
	#AddDir("[COLOR blue][B]Filmes Legendado RedeCanais[/B][/COLOR]" , cPageleg, 91, "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", background="cPageleg")
	#AddDir("[COLOR blue][B]Filmes Nacional RedeCanais[/B][/COLOR]" , cPagenac, 92, "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", background="cPagenac")
	#AddDir("[COLOR gold][B]NetCine.us[/B][/COLOR]" , "", 71, "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg")
	AddDir("[B][COLOR white]Ultimos Adicionados[/COLOR][/B]", "config" , 184,"https://i97.servimg.com/u/f97/19/82/45/70/hqdefa10.jpg", "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", isFolder=True)
	AddDir("[B][COLOR white]Menu Geral de Filmes[/COLOR][/B]", "config" , 180,"https://i97.servimg.com/u/f97/19/82/45/70/hqdefa10.jpg", "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", isFolder=True)
	#AddDir("[COLOR white][B]FilmesOnline.online[/B][/COLOR]" , "", 170, "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg")
	setViewM()
	#AddDir("[COLOR white][B]GoFilmes.me[/B][/COLOR]" , "", 210, "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg")
def MSeries(): #-3

	#AddDir("[COLOR blue][B]Séries RedeCanais[/B][/COLOR]" , cPageser, 130, "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", background="cPageser")
	#AddDir("[COLOR blue][B]Animes RedeCanais[/B][/COLOR]" , cPageser, 140, "https://i.ytimg.com/vi/HyIv_xuCl-Y/maxresdefault.jpg", "https://i.ytimg.com/vi/HyIv_xuCl-Y/maxresdefault.jpg", background="cPageser")
	#AddDir("[COLOR blue][B]Desenhos RedeCanais[/B][/COLOR]" , cPageani, 150, "https://static.noticiasaominuto.com.br/stockimages/1920/naom_58c169a75b16e.jpg?1489070561", "https://static.noticiasaominuto.com.br/stockimages/1920/naom_58c169a75b16e.jpg?1489070561", background="cPageser")
	#AddDir("[COLOR gold][B]Séries NetCine.us[/B][/COLOR]" , "", 60, "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg")
	AddDir("[B][COLOR white]Séries MMFilmes.tv[/COLOR][/B]", "config" , 190,"https://i97.servimg.com/u/f97/19/82/45/70/hqdefa10.jpg", "https://i97.servimg.com/u/f97/19/82/45/70/cats11.jpg", isFolder=True)
	setViewM()
#	setViewM()
# --------------  Fim menu
# --------------  Inicio Filme CB
...
def init_SKindex(msg):
    ...
    link = dialog.select('[B][COLOR white]SUPORTE[/COLOR] [COLOR dimgray]KelTec[/COLOR] [COLOR crimson]Media-Play:[COLOR white] OFICIAL[/COLOR][/B]', ['[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] SITE[/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] AJUDAR PROJETO[/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] [COLOR orange](TOP VIP) [/COLOR][/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] FACEBOOK[/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] YOUTUBE[/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] TELEGRAM[/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] ENTRAR NO ADD-ON[/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] SAIR[/B]'])    
      
    if link == 0:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://keltecmp.net/' ) )
     else:
        ost = webbrowser . open ( 'https://keltecmp.net/' )
    ...
    if link == 3:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
        ...
        ost = webbrowser . open ( 'https://www.facebook.com/groups/KelTec.Media.Play/' )
    
    if link == 4:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         ost = xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://bit.ly/Inscrever-se-KelTec-Media-Play' ) )
     else:
        webbrowser . open ( 'https://bit.ly/Inscrever-se-KelTec-Media-Play' ) 

    if link == 5:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         ost = xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://t.me/KelTec_MP' ) )
     else:
        ost = webbrowser . open ( 'https://t.me/KelTec_MP' )
...
def init_SUPORTE(msg):
    xbmcgui.Dialog().ok('[B][COLOR red]AVISO IMPORTANTE![/COLOR][/B]','[B][COLOR orange]|[/COLOR][/B] OLÁ SEJA BEM-VINDO AO SUPORTE EXCLUSIVO P2P [B][COLOR white]TOP[/COLOR][COLOR gold](VIP)[/COLOR] [COLOR orange]|[/COLOR][/B] QUALIDADE E MUITO ENTRETENIMENTO PARA TODA FAMÍLIA, [B][COLOR orange]|[/COLOR][/B] PEÇA UM TESTE AGORA E PARE DE SOFRER COM TRAVAMENTOS! [B][COLOR orange]|[/COLOR][/B]')
    dialog = xbmcgui.Dialog()
    link = dialog.select('[B][COLOR white]Suporte:[COLOR orange](TOP VIP)[/COLOR] [COLOR dimgray]KelTec[/COLOR] [COLOR crimson]Media-Play:[COLOR white] OFICIAL[/COLOR][/B]', ['[COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] TESTE (TOP VIP)','[COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] DETALHES (TOP VIP)','[COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] APLICATIVO P2P ANDROID','[COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] CONTINUAR NO ADD-ON','[COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] SAIR DO ADD-ON']) 
     
    if link == 0:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://bit.ly/P2P_TESTE' ) )
     else:
        ost = webbrowser . open ( 'https://bit.ly/P2P_TESTE' )
         
    if link == 1:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         ost = xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://bit.ly/P2P_TESTE' ) )
     else:
        webbrowser . open ( 'https://bit.ly/P2P_TESTE' )

    if link == 2:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         ost = xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://bit.ly/Android_P2P' ) )
     else:
        webbrowser . open ( 'https://bit.ly/Android_P2P' )
     
    if link == 4:
     xbmc.executebuiltin("XBMC.Container.Refresh('close()')")
     xbmcplugin.endOfDirectory(int(sys.argv[1]))
     
def INFO_SKindex(msg):
    dialog = xbmcgui.Dialog()
    link = dialog.select('[B][COLOR white]SUPORTE[/COLOR] [COLOR dimgray]KelTec[/COLOR] [COLOR crimson]Media-Play:[COLOR white] OFICIAL[/COLOR][/B]', ['[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] SITE[/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] FACEBOOK[/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] YOUTUBE[/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] VOLTAR[/B]'])    
...
def Doar(msg):
    dialog = xbmcgui.Dialog()
    link = dialog.select('[B][COLOR white]AJUDAR[/COLOR] [COLOR dimgray]KelTec[/COLOR] [COLOR crimson]Media-Play:[COLOR white] PROJETO[/COLOR][/B]', ['[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] [COLOR white]DOAÇÃO[/COLOR] [COLOR darkblue]PAY[/COLOR][COLOR white]PAL[/COLOR] [COLOR orange]$Livre[/COLOR][/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] [COLOR white]DOAÇÃO MP[/COLOR] [COLOR orange]$10[/COLOR][/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] [COLOR green]DOAÇÃO PICPAY[/COLOR] [COLOR orange]$Livre[/COLOR][/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] [COLOR green]DOAÇÃO CONVITE PICPAY[/COLOR] [COLOR orange]$10[/COLOR][/B]','[B][COLOR dimgray]KelTec[/COLOR]-[COLOR crimson]Media-Play[/COLOR][COLOR orange] |[/COLOR] VOLTAR[/B]'])    
        
    if link == 0:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         xbmcgui.Dialog().ok('[B][COLOR red]AVISO IMPORTANTE![/COLOR][/B]','[B][COLOR orange]|[/COLOR][/B]  NÃO OBRIGATÓRIO! [B][COLOR orange]|[/COLOR][/B] ESTE RECURSO É PARA AQUELES QUE ADMIRAM NOSSO TRABALHO KELTEC MEDIA-PLAY, [B][COLOR orange]|[/COLOR][/B] POR FAVOR NÃO SE CINTA OBRIGADO, [B][COLOR orange]|[/COLOR][/B] DOE SOMENTE SE NÃO FOR LHE FAZER FALTA [B][COLOR orange]|[/COLOR] TAMO JUNTO>> AGRADEÇO A TODOS CONTRIBUINTES![/B] [B][COLOR orange]|[/COLOR][/B]')         
         xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://bit.ly/Doar_Paypal' ) )
     else:
        xbmcgui.Dialog().ok('[B][COLOR red]AVISO IMPORTANTE![/COLOR][/B]','[B][COLOR orange]|[/COLOR][/B]  NÃO OBRIGATÓRIO! [B][COLOR orange]|[/COLOR][/B] ESTE RECURSO É PARA AQUELES QUE ADMIRAM NOSSO TRABALHO KELTEC MEDIA-PLAY, [B][COLOR orange]|[/COLOR][/B] POR FAVOR NÃO SE CINTA OBRIGADO, [B][COLOR orange]|[/COLOR][/B] DOE SOMENTE SE NÃO FOR LHE FAZER FALTA [B][COLOR orange]|[/COLOR] TAMO JUNTO>> AGRADEÇO A TODOS CONTRIBUINTES![/B] [B][COLOR orange]|[/COLOR][/B]')
        ost = webbrowser . open ( 'https://bit.ly/Doar_Paypal' )
    ...
    if link == 1:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
        ...
        xbmcgui.Dialog().ok('[B][COLOR red]AVISO IMPORTANTE![/COLOR][/B]','[B][COLOR orange]|[/COLOR][/B]  NÃO OBRIGATÓRIO! [B][COLOR orange]|[/COLOR][/B] ESTE RECURSO É PARA AQUELES QUE ADMIRAM NOSSO TRABALHO KELTEC MEDIA-PLAY, [B][COLOR orange]|[/COLOR][/B] POR FAVOR NÃO SE CINTA OBRIGADO, [B][COLOR orange]|[/COLOR][/B] DOE SOMENTE SE NÃO FOR LHE FAZER FALTA [B][COLOR orange]|[/COLOR] TAMO JUNTO>> AGRADEÇO A TODOS CONTRIBUINTES![/B] [B][COLOR orange]|[/COLOR][/B]')
        ost = webbrowser . open ( 'http://bit.ly/DOAR_10_KELTEC_MEDIA_PLAY' )
    ...
    if link == 2:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
        ...
        xbmcgui.Dialog().ok('[B][COLOR red]AVISO IMPORTANTE![/COLOR][/B]','[B][COLOR orange]|[/COLOR][/B]  NÃO OBRIGATÓRIO! [B][COLOR orange]|[/COLOR][/B] ESTE RECURSO É PARA AQUELES QUE ADMIRAM NOSSO TRABALHO KELTEC MEDIA-PLAY, [B][COLOR orange]|[/COLOR][/B] POR FAVOR NÃO SE CINTA OBRIGADO, [B][COLOR orange]|[/COLOR][/B] DOE SOMENTE SE NÃO FOR LHE FAZER FALTA [B][COLOR orange]|[/COLOR] TAMO JUNTO>> AGRADEÇO A TODOS CONTRIBUINTES![/B] [B][COLOR orange]|[/COLOR][/B]')
        ost = webbrowser . open ( 'https://app.picpay.com/user/keltec_media_play/' )
    ...
    if link == 3:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
        ...
        xbmcgui.Dialog().ok('[B][COLOR red]AVISO IMPORTANTE![/COLOR][/B]','[B][COLOR orange]|[/COLOR][/B]  NÃO OBRIGATÓRIO! [B][COLOR orange]|[/COLOR][/B] ESTE RECURSO É PARA AQUELES QUE ADMIRAM NOSSO TRABALHO KELTEC MEDIA-PLAY, [B][COLOR orange]|[/COLOR][/B] POR FAVOR NÃO SE CINTA OBRIGADO, [B][COLOR orange]|[/COLOR][/B] DOE SOMENTE SE NÃO FOR LHE FAZER FALTA [B][COLOR orange]|[/COLOR] TAMO JUNTO>> AGRADEÇO A TODOS CONTRIBUINTES![/B] [B][COLOR orange]|[/COLOR][/B]')
        ost = webbrowser . open ( 'https://picpay.com/convite?@8GNDLD' )
        

#exec(module_import('https://gitlab.com/Jhonny-lima/supera/raw/master/config.py'))
def Init_CheckUpdate(msg): #43
	try:
		uversao = urllib2.urlopen( "https://raw.githubusercontent.com/Jhonny-lima/Reposit-rio-KelTec-MP/master/Plugins/plugin.video.KelTecPlay/version.txt" ).read().replace('\n','').replace('\r','')
...
def CheckUpdate(msg): #54
	try:
		...
		if uversao != Versao:
            ...
            #xbmc.executebuiltin("XBMC.Container.Refresh(Versao, uversao)")
	except urllib2.URLError, e:
		if msg==True:
			xbmcgui.Dialog().ok('KelTec Play', "Não foi possível checar")
def Update():
	...
	try:
		fonte = urllib2.urlopen( "https://raw.githubusercontent.com/Jhonny-lima/Reposit-rio-KelTec-MP/master/Plugins/plugin.video.KelTecPlay/default.py" ).read().replace('','')
		prog = re.compile('checkintegrity090820').findall(fonte)
		if prog:
			py = os.path.join( Path, "default.py")
			file = open(py, "w")
			file.write(fonte)
			file.close()
		fonte = urllib2.urlopen( "https://raw.githubusercontent.com/Jhonny-lima/Reposit-rio-KelTec-MP/master/Plugins/plugin.video.KelTecPlay/resources/settings.xml" ).read().replace('','')
		...
		if prog:
			...
			file.write(fonte)
			file.close()
		fonte = urllib2.urlopen( "https://raw.githubusercontent.com/Jhonny-lima/Reposit-rio-KelTec-MP/master/Plugins/plugin.video.KelTecPlay/addon.xml" ).read().replace('','')
		...
		if prog:
			...
			file.write(fonte)
			file.close()
		xbmcgui.Dialog().ok('KelTec Play', "OBS: Add-on desatualizaldo! Não se preocupe estamos atualizando o addon. Aguarde um momento! Caso ocorrer erro, por favor Atualize o Add-on no Site Oficial www.keltecmp.net!").xbmc.executebuiltin
	except:
...
def contador():
    ...
    "Referer": "ADD-ON KelTec Play v1.0  >>TEAM KELTEC MEDIA'PLAY<< ",
    "Connection": "keep-alive" 
    }
    request = urllib2.Request("https://whos.amung.us/pingjs/?k=4w80f35j2b", headers=request_headers)
...
def Filmes96(): #220
	...
	setViewM()
def FilmesRC(): #221
	link = common.OpenURL("https://pastebin.com/raw/vgR9tkb7")
	m = link.split("\n")
	link2 = common.OpenURL("https://pastebin.com/raw/W1wj3Bzq")
	i=1
	for x in m:
		try:
			meta = eval(x)
...
def CategoryOrdem(x):
	...
	name2 = "Data" if x2=="0" else "Titulo"
	AddDir("[COLOR white][B]Organizado por:[/B] "+name2 +" (Clique para alterar)[/COLOR]" , x, 81, "http://icons.iconarchive.com/icons/johanchalibert/mac-osx-yosemite/1024/system-preferences-icon.png", "http://icons.iconarchive.com/icons/johanchalibert/mac-osx-yosemite/1024/system-preferences-icon.png", isFolder=False)
def CategoryOrdem2(url):
	x2 = Addon.getSetting(url)
	x = "0" if x2=="1" else "1"
	#xbmcgui.Dialog().ok("Escolha a resolucão:", x + x2 + url)
	...
	try:
		...
		if "None" in background:
			for season,epis in m:
				AddDir("[B][COLOR red] "+season+"[/COLOR][/B]" ,url, 61, iconimage, iconimage, isFolder=True, background=i,info=info2)
				i+=1
		else:
	...
	try:
		...
		for url2 in m:
			...
			for url3 in m3:
				...
				for url4 in m4:
					listal.append(url4)
					dubleg="[COLOR gold]HD[/COLOR][/B]" if "ALTO" in url4 else "[COLOR silver]SD[/COLOR][/B]"
					listaf.append("[B][COLOR green]"+listan[i] +"[/COLOR] "+dubleg)
			i+=1
...
# --------------------------------------
def MoviesNC(): #71
	AddDir("[COLOR gold][B]Genero dos Filmes:[/B] " + Clista2[int(Cat)] +"[/COLOR]", "url" ,80 ,"http://icons.iconarchive.com/icons/johanchalibert/mac-osx-yosemite/1024/system-preferences-icon.png", "http://icons.iconarchive.com/icons/johanchalibert/mac-osx-yosemite/1024/system-preferences-icon.png", isFolder=False)
...
def ListMoviesNC(): #78
	try:
		...
		i=0
		for name2 in m2:
			AddDir(name +" [COLOR gold]("+ name2 +")[/COLOR]", m[i], 79, iconimage, iconimage, isFolder=False, IsPlayable=True, info=info2, background=url)
			i+=1
	except urllib2.URLError, e:
...
def PlayMNC(): #79
	try:
		...
		if m2:
			...
			lista =[]
			for url2 in m2:
				lista.append( "[B][COLOR gold]HD[/COLOR][/B]" if "ALTO" in url2 else "[B][COLOR silver]SD[/COLOR][/B]")
...
def MoviesRCD(): #90 Filme dublado
	AddDir("[COLOR yellow][B][Genero dos Filmes]:[/B] " + Clista2[int(Cat)] +"[/COLOR]", "url" ,80 ,"http://icons.iconarchive.com/icons/johanchalibert/mac-osx-yosemite/1024/system-preferences-icon.png", "http://icons.iconarchive.com/icons/johanchalibert/mac-osx-yosemite/1024/system-preferences-icon.png", isFolder=False)
	CategoryOrdem("cOrdRCF")
	try:
		p= 1
		if int(cPage) > 0:
			AddDir("[COLOR silver][B]<< Pagina Anterior ["+ str( int(cPage) ) +"[/B]][/COLOR]", cPage , 120 ,"https://i97.servimg.com/u/f97/19/82/45/70/url10.png", isFolder=False, background="cPage")
		l= int(cPage)*5
		for x in range(0, 5):
			l +=1
			...
			if match:
				...
				break
		if p >= 60:
			AddDir("[COLOR silver][B]Proxima Pagina >> ["+ str( int(cPage) + 2) +"[/B]][/COLOR]", cPage , 110 ,"https://i97.servimg.com/u/f97/19/82/45/70/proxim10.png", isFolder=False, background="cPage")
	except:
...
def MoviesRCL(): #91 Filme Legendado
	...
	try:
		p= 1
		if int(cPageleg) > 0:
			AddDir("[COLOR silver][B]<< Pagina Anterior ["+ str( int(cPageleg) ) +"[/B]][/COLOR]", cPageleg , 120 ,"https://i97.servimg.com/u/f97/19/82/45/70/url10.png", isFolder=False, background="cPageleg")
		l= int(cPageleg)*5
		for x in range(0, 5):
			l +=1
			...
			if match:
				...
				break
		if p >= 60:
			AddDir("[COLOR silver][B]Proxima Pagina >> ["+ str( int(cPageleg) + 2) +"[/B]][/COLOR]", cPageleg , 110 ,"https://i97.servimg.com/u/f97/19/82/45/70/proxim10.png", isFolder=False, background="cPageleg")
	except:
		AddDir("Server error, tente novamente em alguns minutos" , "", 0, "", "")
def MoviesRCN(): #92 Filmes Nacional
	...
	try:
		p= 1
		if int(cPagenac) > 0:
			AddDir("[COLOR silver][B]<< Pagina Anterior ["+ str( int(cPagenac) ) +"[/B]][/COLOR]", cPagenac , 120 ,"https://i97.servimg.com/u/f97/19/82/45/70/url10.png", isFolder=False, background="cPagenac")
		l= int(cPagenac)*5
		for x in range(0, 5):
			l +=1
			...
			if match:
				...
				break
		if p >= 60:
			AddDir("[COLOR silver][B]Proxima Pagina >> ["+ str( int(cPagenac) + 2) +"[/B]][/COLOR]", cPagenac , 110 ,"https://i97.servimg.com/u/f97/19/82/45/70/proxim10.png", isFolder=False, background="cPagenac")
	except:
...
def MoviesRCR(): # Lancamentos
	...
	try:
		p= 1
		if int(cPagelan) > 0:
			AddDir("[COLOR silver][B]<< Pagina Anterior ["+ str( int(cPagelan) ) +"[/B]][/COLOR]", cPagelan , 120 ,"https://i97.servimg.com/u/f97/19/82/45/70/url10.png", isFolder=False, background="cPagelan")
		l= int(cPagelan)*5
		for x in range(0, 5):
			l +=1
			...
			if match:
				...
				break
		if p >= 60:
			AddDir("[COLOR silver][B]Proxima Pagina >> ["+ str( int(cPagelan) + 2) +"[/B]][/COLOR]", cPagelan , 110 ,"https://i97.servimg.com/u/f97/19/82/45/70/url10.png", isFolder=False, background="cPagelan")
	except:
		AddDir("Server error, tente novamente em alguns minutos" , "", 0, "", "", 0)
	...
	if background=="None":
		...
		for name2,url2,brp in epi:
			...
			if len(urlm) > 1:
				...
				AddDir("[COLOR gold][Dub][/COLOR] "+ name3 +" "+namem ,urlm[0], 133, iconimage, iconimage, info="", isFolder=False, IsPlayable=True)
				AddDir("[COLOR silver][Leg][/COLOR] "+ name3 +" "+namem ,urlm[1], 133, iconimage, iconimage, info="", isFolder=False, IsPlayable=True)
			elif urlm:
...
def SeriesRC(urlrc,pagina2): #130 Lista as Series RC
	try:
		...
		p= 1
		if int(pagina) > 0:
			AddDir("[COLOR silver][B]<< Pagina Anterior ["+ str( int(pagina) ) +"[/B]][/COLOR]", pagina , 120 ,"https://i97.servimg.com/u/f97/19/82/45/70/url10.png", isFolder=False, background=pagina2)
		l= int(pagina)*5
		for x in range(0, 5):
			l +=1
			...
			if match:
				for url2,img2,name2 in match:
					...
					break
		if p >= 60:
			AddDir("[COLOR silver][B]Proxima Pagina >> ["+ str( int(pagina) + 2) +"[/B]][/COLOR]", pagina , 110 ,"http://icons.iconarchive.com/icons/iconsmind/outline/256/Next-2-2-icon.png", isFolder=False, background=pagina2)
	except urllib2.URLError, e:
	...
	if match:
		for name2,url2,brp in match:
			...
			if len(urlm) > 1:
				...
				AddDir("[COLOR gold][Dub][/COLOR] S"+str(S)+" E"+ name3 +" "+namem ,urlm[0], 133, iconimage, iconimage, info="", isFolder=False, IsPlayable=True)
				AddDir("[COLOR silver][Leg][/COLOR] S"+str(S)+" E"+ name3 +" "+namem ,urlm[1], 133, iconimage, iconimage, info="", isFolder=False, IsPlayable=True)
			elif urlm:
...
# ----------------- BUSCA
def Busca(): # 160
	AddDir("[COLOR withe][B][Nova Busca][/B][/COLOR]", "" , 50 ,"", isFolder=False)
	...
	#try:
		#AddDir("[COLOR gold][B][NetCine.us][/B][/COLOR]", "" , 0 ,"", isFolder=False)
	...
	i=0
	try:
		AddDir("[B][COLOR white]KelTec[/COLOR] [COLOR crimson]Play: [/COLOR][COLOR silver]Filmes & Séries[/B][/COLOR]", "" , 0 ,"", isFolder=False)
		...
		for x in range(0, 3):
			...
			if m:
				for name2,b,url2 in m:
					name2 = name2.replace("&#8211;","-").replace("&#038;","&").replace("&#8217;","\'")
					if not url2 in ms:
						AddDir(name2+ " [COLOR glod]"+res[i]+"[/COLOR] [COLOR orange]"+dubleg[i]+"[/COLOR]", url2, 181, jpg[i], jpg[i],isFolder=True,IsPlayable=False)
					else:
	...
	i=0
	try:
		#AddDir("[COLOR green][B][Gofilmes.me][/B][/COLOR]", "" , 0 ,"", isFolder=False)
		for x in range(0, 3):
			l+=1
...
def TVRC(): #100
	link = urllib2.urlopen("http://KelTecPlay-iptv.directorioforuns.com/h64-").read().replace('\n','').replace('\r','')
...
def MoviesFO(urlfo,pagina2): #170
	AddDir("[COLOR yellow][B][Gênero dos Filmes]:[/B] " + Clistafo1[int(Catfo)] +"[/COLOR]", "url" ,85 ,"http://icons.iconarchive.com/icons/johanchalibert/mac-osx-yosemite/1024/system-preferences-icon.png", "http://icons.iconarchive.com/icons/johanchalibert/mac-osx-yosemite/1024/system-preferences-icon.png", isFolder=False)
	...
	try:
		...
		for x in range(0, 5):
			...
			i=0
			if m:
				#xbmcgui.Dialog().ok('KelTec Play', str(m))
				for img2,name2,url2 in m:
					...
					i+=1
		if p >= 80:
			AddDir("[COLOR silver][B]Proxima Pagina >> ["+ str( int(pagina) + 2) +"[/B]][/COLOR]", pagina , 110 ,"https://i97.servimg.com/u/f97/19/82/45/70/proxim10.png", isFolder=False, background=pagina2)
	except urllib2.URLError, e:
		AddDir("Server error, tente novamente em alguns minutos" , "", 0, "", "")
...
def PlayMFO1(): #172
	if re.compile('\d+').findall(str ( background )) :
		s = background.split(",")
		sel = xbmcgui.Dialog().select("Selecione a resolucão", s)
		if sel!=-1:
		...
		if m:
			...
			if m2:
				...
				if m3:
					...
					AddDir( "Resolucões: "+", ".join(pp), "https:"+m2[0], 0, iconimage, iconimage, isFolder=False, info="Clique no titulo do filme para dar play")
				else:
		...
		for x in range(0, 5):
			...
			if m:
				for name2,b,url2 in m:
					name2 = name2.replace("&#8211;","-").replace("&#038;","&").replace("&#8217;","\'")
					if not url2 in ms:
						AddDir(name2+ " [COLOR gold]"+res[i]+"[/COLOR] [COLOR silver]"+dubleg[i]+"[/COLOR]", url2, 181, jpg[i], jpg[i],isFolder=True,IsPlayable=False)
					i+=1
			i=0
	except:
		pass
...
def ListFilmeMM(pagina2): #180
	AddDir("[COLOR yellow][B][Gênero dos Filmes]:[/B] " + ClistaMM1[int(CatMM)] +"[/COLOR]", "url" ,189 ,"http://icons.iconarchive.com/icons/johanchalibert/mac-osx-yosemite/1024/system-preferences-icon.png", "http://icons.iconarchive.com/icons/johanchalibert/mac-osx-yosemite/1024/system-preferences-icon.png", isFolder=False)
	pagina=eval(pagina2)
	l= int(pagina)*5
	p=1
	i=0
	...
	if m:
		...
		if m2:
			...
			for link,dubleg in m2:
				AddDir( name2 +" [COLOR gold]("+dubleg+")[/COLOR]" ,link, 182, iconimage, iconimage, isFolder=False, IsPlayable=True, info=info2, background=url)
def PlayLinkMM(): #182
	link = common.OpenURL(url,headers={'referer': "http://www.mmfilmes.tv/"})
	m = re.compile('addiframe\(\'([^\']+)').findall(link)
	if m:
		m[0] = "https://player.openload.network" + m[0] if not "http" in m[0] else m[0]
		link2 = common.OpenURL(m[0],headers={'referer': "https://player.openload.network"}).replace("file","\nfile")
		...
		if len(listal) <1:
			...
			sys.exit(int(sys.argv[1]))
		d = xbmcgui.Dialog().select("Selecione a resolucão", listar)
		if d!= -1:
			...
			if legenda:
				...
				if not "http" in legenda:
					legenda = "https://player.openload.network/" + legenda
...
def ListEpiMM(x): #192
	...
	for e,url2 in epi:
		url2 = "https://player.openload.network" + url2 if not "http" in url2 else url2
		if p == int(e) :
			r+=1
		if len(dubleg[r][1]) < 30:
			r+=1
		name2 = "[COLOR gold](Dub)[/COLOR]" if "dub" in dubleg[r][0] else "[COLOR silver](Leg)[/COLOR]"
		AddDir("Episodio "+ e + " [COLOR blue]" + name2 ,url2, 194, iconimage, iconimage, isFolder=False, IsPlayable=True, info=info)
def PlaySMM(): #194
	if "drive.google" in url:
		xbmcgui.Dialog().ok('KelTec Play', 'Erro, video não encontrado')
		sys.exit()
	link2 = common.OpenURL(url,headers={'referer': "https://player.openload.network"}).replace('"',"'")
...
def ListGO(pagina2): #210
	AddDir("[COLOR gold][B]Gênero dos Filmes:[/B] " + ClistaGO1[int(CatGO)] +"[/COLOR]", "url" ,219 ,"http://icons.iconarchive.com/icons/johanchalibert/mac-osx-yosemite/1024/system-preferences-icon.png", "http://icons.iconarchive.com/icons/johanchalibert/mac-osx-yosemite/1024/system-preferences-icon.png", isFolder=False)
	pagina=eval(pagina2)
	l= int(pagina)*5
	p=1
	i=0
	if int(pagina) > 0:
		AddDir("[COLOR silver][B]<< Pagina Anterior ["+ str( int(pagina) ) +"[/B]][/COLOR]", pagina , 120 ,"http://icons.iconarchive.com/icons/iconsmind/outline/256/Previous-icon.png", isFolder=False, background=pagina2)
	try:
		for x in range(0, 5):
			l+=1
...
def PlayGO(): #211
	try:
		...
		for url3,dl3 in m2:
			...
			for res4,url4 in m3:
				listn.append("[COLOR green]"+ m2[i][1] +"[/COLOR] " + "[COLOR yellow]"+ res4 +"[/COLOR]")
				listu.append(url4)
			i+=1
		if len(listn) >=1:
			...
			xbmcgui.Dialog().ok("KelTec Play", "Não foi possível carregar o vídeo")
	except:
		xbmcgui.Dialog().ok("KelTec Play", "Não foi possível carregar o vídeo")
# ----------------- Fim Go Filmes
...
def AddDir(name, url, mode, iconimage='', logos='', index=-1, move=0, isFolder=True, IsPlayable=False, background=None, cacheMin='0', info='', metah=''):
	...
	if mode == 1 or mode == 2:
		...
		liz.addContextMenuItems(items = [("Add ao fav. do KelTec Play", 'XBMC.RunPlugin({0}?url={1}&mode=31&iconimage={2}&name={3})'.format(sys.argv[0], urllib.quote_plus(url), urllib.quote_plus(iconimage), urllib.quote_plus(name)))])
	elif mode== 78:
		liz.addContextMenuItems(items = [("Add ao fav. do KelTec Play", 'XBMC.RunPlugin({0}?url={1}&mode=72&iconimage={2}&name={3})'.format(sys.argv[0], urllib.quote_plus(url), urllib.quote_plus(iconimage), urllib.quote_plus(name)))])
	elif mode== 95:
		liz.addContextMenuItems(items = [("Add ao fav. do KelTec Play", 'XBMC.RunPlugin({0}?url={1}&mode=93&iconimage={2}&name={3})'.format(sys.argv[0], urllib.quote_plus(url), urllib.quote_plus(iconimage), urllib.quote_plus(name)))])
	elif mode== 135:
		liz.addContextMenuItems(items = [("Add ao fav. do KelTec Play", 'XBMC.RunPlugin({0}?url={1}&mode=131&iconimage={2}&name={3})'.format(sys.argv[0], urllib.quote_plus(url), urllib.quote_plus(iconimage), urllib.quote_plus(name)))])
	elif mode== 171:
		liz.addContextMenuItems(items = [("Add ao fav. do KelTec Play", 'XBMC.RunPlugin({0}?url={1}&mode=175&iconimage={2}&name={3})'.format(sys.argv[0], urllib.quote_plus(url), urllib.quote_plus(iconimage), urllib.quote_plus(name)))])
	elif mode== 181:
		liz.addContextMenuItems(items = [("Add ao fav. do KelTec Play", 'XBMC.RunPlugin({0}?url={1}&mode=185&iconimage={2}&name={3})'.format(sys.argv[0], urllib.quote_plus(url), urllib.quote_plus(iconimage), urllib.quote_plus(name)))])
	elif mode== 191:
		liz.addContextMenuItems(items = [("Add ao fav. do KelTec Play", 'XBMC.RunPlugin({0}?url={1}&mode=195&iconimage={2}&name={3})'.format(sys.argv[0], urllib.quote_plus(url), urllib.quote_plus(iconimage), urllib.quote_plus(name)))])
...
def ToggleNext(url, background):
	#xbmcgui.Dialog().ok('KelTec Play', url + " " +background)
	Addon.setSetting(background, str(int(url) + 1) )
	xbmc.executebuiltin("XBMC.Container.Refresh()")
...
#MODULO-MMF
#exec(module_import('https://gitlab.com/Jhonny-lima/supera/raw/master/MODULO-MMF')) 
...
if mode == 0:
	...
	dialog = xbmcgui.Dialog()
	ret = dialog.yesno('KelTec Play', 'Deseja mesmo deletar todos os filmes favoritos?')
	if ret:
		common.DelFile(favfilmesFile)
		sys.exit()
elif mode == 39:
	dialog = xbmcgui.Dialog()
	ret = dialog.yesno('KelTec Play', 'Deseja mesmo deletar todos os seriados favoritos?')
	if ret:
		common.DelFile(favseriesFile)
		sys.exit()
elif mode == 40:
	dialog = xbmcgui.Dialog()
	ret = dialog.yesno('KelTec Play', 'Deseja mesmo deletar todo o historico?')
	if ret:
